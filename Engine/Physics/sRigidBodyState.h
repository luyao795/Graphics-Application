...
namespace eae6320
{
	namespace Physics
	{
		struct sRigidBodyState
		{
			...
			Math::cQuaternion IncrementPredictionOntoRotation( const float i_secondCountToExtrapolate );
			Math::cQuaternion DecrementPredictionOntoRotation( const float i_secondCountToExtrapolate );
		};
	}
}
