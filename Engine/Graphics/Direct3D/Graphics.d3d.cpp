...
void eae6320::Graphics::RenderFrame()
{
	...
	s_sprite.direct3dImmediateContext = direct3dImmediateContext;
	...
	//	{
	//		EAE6320_ASSERT( s_sprite.s_vertexBuffer );
	...
	//		direct3dImmediateContext->IASetVertexBuffers( startingSlot, vertexBufferCount, &s_sprite.s_vertexBuffer, &bufferStride, &bufferOffset );
	//	}
	//	// Specify what kind of data the vertex buffer holds
	//	{
	//		// Set the layout (which defines how to interpret a single vertex)
	//		{
	//			EAE6320_ASSERT( s_sprite.s_vertexInputLayout );
	//			direct3dImmediateContext->IASetInputLayout( s_sprite.s_vertexInputLayout );
	//		}
...
eae6320::cResult eae6320::Graphics::CleanUp()
{
	...
	/*if ( s_sprite.s_vertexBuffer )
	{
		s_sprite.s_vertexBuffer->Release();
		s_sprite.s_vertexBuffer = nullptr;
	}
	if ( s_sprite.s_vertexInputLayout )
	{
		s_sprite.s_vertexInputLayout->Release();
		s_sprite.s_vertexInputLayout = nullptr;
	}*/
...
namespace
{
	...
	//				vertexShaderDataFromFile.data, vertexShaderDataFromFile.size, &s_sprite.s_vertexInputLayout );
	//			if ( FAILED( result ) )
	//			{
	...
	//		const auto d3dResult = direct3dDevice->CreateBuffer( &bufferDescription, &initialData, &s_sprite.s_vertexBuffer );
	//		if ( FAILED( d3dResult ) )
	//		{
	//			result = eae6320::Results::Failure;
